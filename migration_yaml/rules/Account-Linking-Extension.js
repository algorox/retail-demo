...
async function accountLinking(user, context, cb) {
  ...
  const config = {
    endpoints: {
      linking:
        "https://webtask.demo-platform.auth0app.com/api/run/julian-new/4cb95bf92ced903b9b84ebedbf5ebffd",
      userApi: `${auth0.baseUrl}/users`,
      usersByEmailApi: `${auth0.baseUrl}/users-by-email`,
    },
    token: {
      clientId: "3df52817f0934d7c53b15fcd4f98a63ebd10c472cef9426cf80ede7cc6776bfa",
      clientSecret: "063e592b4f2ed844e74735c06555cccfd1443e8ccfa74d722e99fecdc05d2630e1c879352ab30241cc506865c3922cd3797742fc209c71879939a17ae687f2d3",
      issuer: auth0.domain,
    },
  };
