        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (Object.keys(emailProvider).length === 0) {
                if (this.config('AUTH0_ALLOW_DELETE') === true) {
                    logger_1.default.warn('Setting email provider to empty object will delete the provider in future versions. The current inability to delete is considered a bug. For more details see: https://github.com/auth0/auth0-deploy-cli/issues/653');
                }
                return;
            }
            if (existing.name) {
