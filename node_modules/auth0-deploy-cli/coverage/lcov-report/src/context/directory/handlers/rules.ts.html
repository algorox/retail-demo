...
<head>
    <title>Code coverage report for src/context/directory/handlers/rules.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/directory/handlers</a> rules.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  const rules = files.map((f) =&gt; {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (rule.script) {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!rules) <span class="cstat-no" title="statement not covered" >return; </span>// Skip, nothing to dump
&nbsp;
  // Create Rules folder
  const rulesFolder = path.join(context.filePath, constants.RULES_DIRECTORY);
