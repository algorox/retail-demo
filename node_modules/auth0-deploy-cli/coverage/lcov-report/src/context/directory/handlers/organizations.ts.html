...
<head>
    <title>Code coverage report for src/context/directory/handlers/organizations.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/directory/handlers</a> organizations.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (organization.connections.length &gt; 0) {
      organization.connections = organization.connections.map((c) =&gt; {
        // connection is a computed field
        const name = c.connection &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >c.connection.name;</span>
&nbsp;
        const conn = {
          name,
          ...c,
