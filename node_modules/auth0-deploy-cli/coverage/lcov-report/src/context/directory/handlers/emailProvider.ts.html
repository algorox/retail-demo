...
<head>
    <title>Code coverage report for src/context/directory/handlers/emailProvider.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/directory/handlers</a> emailProvider.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (isFile(providerFile)) {
    return {
      emailProvider: loadJSON(providerFile, context.mappings),
    };
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return { emailProvider: null };</span>
}
&nbsp;
async function dump(context: DirectoryContext): Promise&lt;void&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!context.assets.emailProvider) <span class="cstat-no" title="statement not covered" >return; </span>// Skip, nothing to dump
&nbsp;
  const emailProvider: typeof context.assets.emailProvider = (() =&gt; {
    const excludedDefaults = context.assets.exclude<span class="branch-0 cbranch-no" title="branch not covered" >?.d</span>efaults || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
