...
<head>
    <title>Code coverage report for src/context/directory/handlers/themes.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/directory/handlers</a> themes.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!themeDefinitionsFiles.length) {
<span class="cstat-no" title="statement not covered" >    return { themes: [] };</span>
  }
&nbsp;
