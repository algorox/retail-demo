...
<head>
    <title>Code coverage report for src/context/directory/handlers/hooks.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/directory/handlers</a> hooks.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  const hooks = files.map((f) =&gt; {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (hook.script) {
