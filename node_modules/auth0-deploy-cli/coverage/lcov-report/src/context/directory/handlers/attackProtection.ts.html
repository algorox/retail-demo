...
<head>
    <title>Code coverage report for src/context/directory/handlers/attackProtection.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/directory/handlers</a> attackProtection.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!attackProtection) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
  const files = attackProtectionFiles(context.filePath);
