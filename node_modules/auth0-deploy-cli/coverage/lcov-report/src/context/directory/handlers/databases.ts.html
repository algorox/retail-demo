...
<head>
    <title>Code coverage report for src/context/directory/handlers/databases.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/directory/handlers</a> databases.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    log.warn(`Skipping database folder ${folder} as ${metaFile} is empty`);</span>
...
&nbsp;
  const database = {
    ...
    options: {
      ...
      ...metaData.options,
      //@ts-ignore because this code exists currently, but still needs to be understood if it is correct or not
      ...(metaData.customScripts &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >{ customScripts: metaData.customScripts })</span>,
    },
  };
&nbsp;
  ...
  if (database.options.customScripts) {
    Object.entries(database.options.customScripts).forEach(([name, script]) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!constants.DATABASE_SCRIPTS.includes(name)) {
        // skip invalid keys in customScripts object
<span class="cstat-no" title="statement not covered" >        log.warn('Skipping invalid database configuration: ' + name);</span>
      } else {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!databases) <span class="cstat-no" title="statement not covered" >return; </span>// Skip, nothing to dump
&nbsp;
...
&nbsp;
    const sortCustomScripts = (name1: string, name2: string): 1 | 0 | -1 =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (name1 === name2) <span class="cstat-no" title="statement not covered" >return 0;</span>
      return name1 &gt; name2 ? 1 : <span class="branch-1 cbranch-no" title="branch not covered" >-1;</span>
    };
&nbsp;
    const formatted = {
      ...database,
