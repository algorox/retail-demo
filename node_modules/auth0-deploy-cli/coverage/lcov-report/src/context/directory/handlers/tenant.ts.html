...
<head>
    <title>Code coverage report for src/context/directory/handlers/tenant.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/directory/handlers</a> tenant.ts</h1>
        <div class='clearfix'>
...
function parse(context: DirectoryContext): ParsedTenant {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!existsMustBeDir(baseFolder)) <span class="cstat-no" title="statement not covered" >return { tenant: null }; </span>// Skip
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!tenant) <span class="cstat-no" title="statement not covered" >return; </span>// Skip, nothing to dump
&nbsp;
  clearTenantFlags(tenant);
&nbsp;
