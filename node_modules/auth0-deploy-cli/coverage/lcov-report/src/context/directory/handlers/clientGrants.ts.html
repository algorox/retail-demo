...
<head>
    <title>Code coverage report for src/context/directory/handlers/clientGrants.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/directory/handlers</a> clientGrants.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!clientGrants) <span class="cstat-no" title="statement not covered" >return; </span>// Skip, nothing to dump
&nbsp;
  const grantsFolder = path.join(context.filePath, constants.CLIENTS_GRANTS_DIRECTORY);
...
&nbsp;
  ...
  clientGrants.forEach((grant) =&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (context.assets.clientsOrig)
<span class="cstat-no" title="statement not covered" >      dumpGrant.client_id = convertClientIdToName(dumpGrant.client_id, context.assets.clientsOrig);</span>
&nbsp;
