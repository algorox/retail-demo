...
<head>
    <title>Code coverage report for src/context/directory/handlers/emailTemplates.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/directory/handlers</a> emailTemplates.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >        log.warn(`Skipping email template file ${html} as missing the corresponding '.json' file`);</span>
<span class="cstat-no" title="statement not covered" >        return [];</span>
      } else <span class="missing-if-branch" title="if path not taken" >I</span>if (!html) {
<span class="cstat-no" title="statement not covered" >        log.warn(`Skipping email template file ${meta} as missing corresponding '.html' file`);</span>
<span class="cstat-no" title="statement not covered" >        return [];</span>
      } else {
        return {
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!emailTemplates) <span class="cstat-no" title="statement not covered" >return; </span>// Skip, nothing to dump
&nbsp;
