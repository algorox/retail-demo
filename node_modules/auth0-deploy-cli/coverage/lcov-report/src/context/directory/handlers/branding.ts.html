...
<head>
    <title>Code coverage report for src/context/directory/handlers/branding.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/directory/handlers</a> branding.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!branding) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
  dumpBranding(context);
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (!!branding.templates) dumpBrandingTemplates(context);
}
&nbsp;
const dumpBrandingTemplates = ({ filePath, assets }: DirectoryContext): void =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!assets.branding || !assets.branding.templates) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
  const {
    branding: { templates = <span class="branch-0 cbranch-no" title="branch not covered" >[] </span>},
  } = assets;
&nbsp;
  const brandingTemplatesFolder = path.join(
    filePath,
...
const dumpBranding = ({ filePath, assets }: DirectoryContext): void =&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!assets || !assets.branding) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
