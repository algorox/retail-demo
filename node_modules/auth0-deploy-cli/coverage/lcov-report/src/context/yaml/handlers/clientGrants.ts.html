...
<head>
    <title>Code coverage report for src/context/yaml/handlers/clientGrants.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/yaml/handlers</a> clientGrants.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { convertClientIdToName } from '../../../utils';
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!clientGrants) <span class="cstat-no" title="statement not covered" >return { clientGrants: null };</span>
&nbsp;
