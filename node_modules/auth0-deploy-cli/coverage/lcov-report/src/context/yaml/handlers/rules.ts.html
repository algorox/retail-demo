...
<head>
    <title>Code coverage report for src/context/yaml/handlers/rules.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/yaml/handlers</a> rules.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    return { rules: null };</span>
  }
&nbsp;
  // Create Rules folder
