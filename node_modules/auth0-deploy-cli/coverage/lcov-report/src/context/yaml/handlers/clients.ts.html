...
<head>
    <title>Code coverage report for src/context/yaml/handlers/clients.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/yaml/handlers</a> clients.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  const { clients } = context.assets;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!clients) <span class="cstat-no" title="statement not covered" >return { clients: null };</span>
&nbsp;
  return {
    clients: [
      ...clients.map((client) =&gt; {
