...
<head>
    <title>Code coverage report for src/context/yaml/handlers/emailProvider.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/yaml/handlers</a> emailProvider.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { emailProviderDefaults } from '../../defaults';
...
async function dump(context: YAMLContext): Promise&lt;ParsedEmailProvider&gt; {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!context.assets.emailProvider) <span class="cstat-no" title="statement not covered" >return { emailProvider: null };</span>
&nbsp;
  const emailProvider = (() =&gt; {
    const { emailProvider } = context.assets;
