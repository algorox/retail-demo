...
<head>
    <title>Code coverage report for src/context/yaml/handlers/databases.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/yaml/handlers</a> databases.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!databases) <span class="cstat-no" title="statement not covered" >return { databases: null };</span>
&nbsp;
