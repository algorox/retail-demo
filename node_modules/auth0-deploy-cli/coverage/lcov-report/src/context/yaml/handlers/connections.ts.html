...
<head>
    <title>Code coverage report for src/context/yaml/handlers/connections.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/yaml/handlers</a> connections.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!connections) <span class="cstat-no" title="statement not covered" >return { connections: null };</span>
&nbsp;
  return {
    connections: connections.map((connection) =&gt; {
      const dumpedConnection = {
        ...
        ...(connection.enabled_clients &amp;&amp; {
          enabled_clients: mapClientID2NameSorted(connection.enabled_clients, clients || <span class="branch-1 cbranch-no" title="branch not covered" >[])</span>,
        }),
      };
&nbsp;
