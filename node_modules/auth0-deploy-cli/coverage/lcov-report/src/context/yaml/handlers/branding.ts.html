...
<head>
    <title>Code coverage report for src/context/yaml/handlers/branding.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/yaml/handlers</a> branding.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!context.assets.branding) <span class="cstat-no" title="statement not covered" >return { branding: null };</span>
&nbsp;
  const {
    branding: { templates, ...branding },
  } = context.assets;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!templates) {
<span class="cstat-no" title="statement not covered" >    return { branding: { ...branding } };</span>
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!branding) <span class="cstat-no" title="statement not covered" >return { branding: null };</span>
&nbsp;
