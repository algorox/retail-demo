...
<head>
    <title>Code coverage report for src/context/yaml/handlers/rulesConfigs.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/yaml/handlers</a> rulesConfigs.ts</h1>
        <div class='clearfix'>
...
async function dump(context: YAMLContext): Promise&lt;ParsedRulesConfigs&gt; {
  const { rulesConfigs } = context.assets;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!rulesConfigs) <span class="cstat-no" title="statement not covered" >return { rulesConfigs: null };</span>
&nbsp;
  return {
