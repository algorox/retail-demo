...
<head>
    <title>Code coverage report for src/context/yaml/handlers/organizations.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/yaml/handlers</a> organizations.ts</h1>
        <div class='clearfix'>
...
async function dump(context: YAMLContext): Promise&lt;ParsedOrganizations&gt; {
  const { organizations } = context.assets;
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!organizations) <span class="cstat-no" title="statement not covered" >return { organizations: null };</span>
&nbsp;
  return {
    organizations: organizations.map((org) =&gt; {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (org.connections.length &gt; 0) {
