...
<head>
    <title>Code coverage report for src/context/yaml/handlers/triggers.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/yaml/handlers</a> triggers.ts</h1>
        <div class='clearfix'>
...
async function dump(context: YAMLContext): Promise&lt;ParsedTriggers&gt; {
  ...
  // Nothing to do
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!triggers) <span class="cstat-no" title="statement not covered" >return { triggers: null };</span>
  return {
    triggers: triggers,
  };
}
