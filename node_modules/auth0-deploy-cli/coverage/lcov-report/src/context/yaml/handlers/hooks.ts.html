...
<head>
    <title>Code coverage report for src/context/yaml/handlers/hooks.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/context/yaml/handlers</a> hooks.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!hooks) {
<span class="cstat-no" title="statement not covered" >    return { hooks: null };</span>
  }
&nbsp;
  // Create hooks folder
