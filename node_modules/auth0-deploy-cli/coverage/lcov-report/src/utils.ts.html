...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1414x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1283x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
...
export function dumpJSON(file: string, mappings: { [key: string]: any }): void {
  try {
    ...
    fs.writeFileSync(file, jsonBody.endsWith('\n') ? <span class="branch-0 cbranch-no" title="branch not covered" >jsonBody </span>: `${jsonBody}\n`);
  } catch (e) {
...
export function ensureProp(obj: Asset, props: string): void {
  const value = '';
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!dotProp.has(obj, props)) {
<span class="cstat-no" title="statement not covered" >    dotProp.set(obj, props, value);</span>
  }
}
&nbsp;
