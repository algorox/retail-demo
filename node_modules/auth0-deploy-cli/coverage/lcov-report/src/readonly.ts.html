...
<head>
    <title>Code coverage report for src/readonly.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> readonly.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  Object.entries(included).forEach(([name, fields]) =&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (strippedFields[name]) {
