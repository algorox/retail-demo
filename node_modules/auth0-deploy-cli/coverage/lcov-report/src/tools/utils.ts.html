...
<head>
    <title>Code coverage report for src/tools/utils.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/tools</a> utils.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">98.5% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>132/134</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>114/115</span>
            </div>
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (stripped) {
...
&nbsp;
  ...
  const enabledClients = [
    ...convertClientNamesToIds(connection.enabled_clients || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span> clients).filter(
...
&nbsp;
export function <span class="fstat-no" title="function not covered" >areArraysEquals(</span>x: any[], y: any[]): boolean {
<span class="cstat-no" title="statement not covered" >  return _.isEqual(x &amp;&amp; x.sort(), y &amp;&amp; y.sort());</span>
}
&nbsp;
...
export const stripObfuscatedFieldsFromPayload = (
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (data === null) <span class="cstat-no" title="statement not covered" >return data;</span>
  if (Array.isArray(data)) {
...
&gt; =&gt; {
  try {
    ...
    if (err.statusCode === 403 &amp;&amp; err.message.includes('Insufficient scope')) {
      const requiredScopes = err.message<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>plit('Insufficient scope, expected any of: ')<span class="branch-0 cbranch-no" title="branch not covered" >?.s</span>lice(1);
      return {
