...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/emailProvider.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> emailProvider.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >      if (err.statusCode === 404) <span class="cstat-no" title="statement not covered" >return {};</span></span>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!emailProvider) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
    let existing = await this.getType();
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (Object.keys(emailProvider).length === 0) {
<span class="cstat-no" title="statement not covered" >      if (this.config('AUTH0_ALLOW_DELETE') === true) {</span>
