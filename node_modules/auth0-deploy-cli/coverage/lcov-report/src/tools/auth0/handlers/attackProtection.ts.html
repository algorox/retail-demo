...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/attackProtection.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> attackProtection.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import DefaultAPIHandler from './default';
...
&nbsp;
  objString(item: Asset): string {
    const objectString = (() =&gt; {
      let obj = {};
      <span class="missing-if-branch" title="else path not taken" >E</span>if (item.breachedPasswordDetection<span class="branch-0 cbranch-no" title="branch not covered" >?.e</span>nabled) {
        obj['breached-password-protection'] = {
          enabled: item.breachedPasswordDetection.enabled,
        };
      }
      <span class="missing-if-branch" title="else path not taken" >E</span>if (item.bruteForceProtection<span class="branch-0 cbranch-no" title="branch not covered" >?.e</span>nabled) {
        obj['brute-force-protection'] = {
          enabled: item.bruteForceProtection.enabled,
        };
      }
      <span class="missing-if-branch" title="else path not taken" >E</span>if (item.suspiciousIpThrottling<span class="branch-0 cbranch-no" title="branch not covered" >?.e</span>nabled) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!attackProtection || !Object.keys(attackProtection).length) {
