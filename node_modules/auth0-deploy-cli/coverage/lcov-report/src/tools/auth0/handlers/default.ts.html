...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/default.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> default.ts</h1>
        <div class='clearfix'>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>27/35</span>
            </div>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3813x</span>
<span class="cline-any cline-yes">3813x</span>
<span class="cline-any cline-yes">3813x</span>
<span class="cline-any cline-yes">3813x</span>
<span class="cline-any cline-yes">3813x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1810x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1810x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import ValidationError from '../../validationError';
&nbsp;
import {
  stripFields,
  convertJsonToString,
...
&nbsp;
  async <span class="fstat-no" title="function not covered" >getType(</span>): Promise&lt;Asset | Asset[] | null&gt; {
    // Each type to impl how to get the existing as its not consistent across the mgnt api.
<span class="cstat-no" title="statement not covered" >    throw new Error(`Must implement getType for type ${this.type}`);</span>
  }
&nbsp;
  async load(): Promise&lt;{ [key: string]: Asset | Asset[] | null }&gt; {
    ...
    const data = await (async () =&gt; {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!hadSufficientScopes) {
<span class="cstat-no" title="statement not covered" >        log.warn(`Cannot retrieve ${this.type} due to missing scopes: ${requiredScopes}`);</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!typeAssets) {
...
&nbsp;
    const del = changes.del || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
    const update = changes.update || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
    const create = changes.create || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
    const conflicts = changes.conflicts || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
&nbsp;
    log.debug(
    ...
    if (del.length &gt; 0) {
      ...
      if (!shouldDelete) {
        ...
        await this.client.pool
          .addEachTask({
            data: del || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span>
            generator: (delItem) =&gt; {
...
&nbsp;
    ...
    await this.client.pool
      .addEachTask({
        data: conflicts || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span>
        generator: <span class="fstat-no" title="function not covered" >(u</span>pdateItem) =&gt; {
          const updateFN = <span class="cstat-no" title="statement not covered" >this.getClientFN(this.functions.update);</span>
          const params = <span class="cstat-no" title="statement not covered" >{ [this.id]: updateItem[this.id] };</span>
          const updatePayload = <span class="cstat-no" title="statement not covered" >(<span class="fstat-no" title="function not covered" >() =</span>&gt; {</span>
            let data = <span class="cstat-no" title="statement not covered" >stripFields({ ...updateItem }, this.stripUpdateFields);</span>
<span class="cstat-no" title="statement not covered" >            return stripObfuscatedFieldsFromPayload(data, this.sensitiveFieldsToObfuscate);</span>
          })();
<span class="cstat-no" title="statement not covered" >          return updateFN(params, updatePayload)</span>
            .then(<span class="fstat-no" title="function not covered" >(d</span>ata) =&gt; <span class="cstat-no" title="statement not covered" >this.didUpdate(data))</span>
            .catch(<span class="fstat-no" title="function not covered" >(e</span>rr) =&gt; {
<span class="cstat-no" title="statement not covered" >              throw new Error(</span>
...
&nbsp;
    ...
    await this.client.pool
      .addEachTask({
        data: create || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span>
...
&nbsp;
    ...
    await this.client.pool
      .addEachTask({
        data: update || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span>
