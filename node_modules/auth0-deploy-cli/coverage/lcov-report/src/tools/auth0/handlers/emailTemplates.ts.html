...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/emailTemplates.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> emailTemplates.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  async updateOrCreate(emailTemplate): Promise&lt;void&gt; {
    try {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (err.statusCode === 404) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!emailTemplates || !emailTemplates.length) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
    await Promise.all(
