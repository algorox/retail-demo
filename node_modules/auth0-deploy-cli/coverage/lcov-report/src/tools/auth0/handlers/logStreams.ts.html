...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/logStreams.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> logStreams.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  async processChanges(assets: Assets): Promise&lt;void&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!logStreams) <span class="cstat-no" title="statement not covered" >return;</span>
    // Figure out what needs to be updated vs created
    const changes = await this.calcChanges(assets).then((changes) =&gt; {
      return {
        ...changes,
        update: changes.update.map((update: LogStream) =&gt; {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (update.type === 'eventbridge' || update.type === 'eventgrid') {
<span class="cstat-no" title="statement not covered" >            delete update.sink;</span>
          }
          return update;
        }),
      };
