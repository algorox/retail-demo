...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/themes.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> themes.ts</h1>
        <div class='clearfix'>
...
<a name='L600'></a><a href='#L600'>600</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Asset, Assets } from '../../../types';
...
&nbsp;
  objString(theme: Theme): string {
    return theme.displayName || <span class="branch-1 cbranch-no" title="branch not covered" >JSON.stringify(theme);</span>
  }
&nbsp;
  async getType(): Promise&lt;Theme[] | null&gt; {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.existing) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!themes) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (currentThemes === null || currentThemes.length === 0) {
<span class="cstat-no" title="statement not covered" >      return;</span>
    }
&nbsp;
...
&nbsp;
  async updateThemes(themes: Theme[]): Promise&lt;void&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (themes.length &gt; 1) {
<span class="cstat-no" title="statement not covered" >      log.warn('Only one theme is supported per tenant');</span>
    }
&nbsp;
    const currentThemes = await this.getThemes();
&nbsp;
