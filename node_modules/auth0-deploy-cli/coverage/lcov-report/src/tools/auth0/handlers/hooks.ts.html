...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/hooks.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> hooks.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    hooks.forEach((hook) =&gt; {
      ...
      if (current) {
        ...
        const oldSecrets = current.secrets || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
...
&nbsp;
  ...
  async getType(reload: boolean): Promise&lt;Asset[]&gt; {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.existing &amp;&amp; !reload) {
<span class="cstat-no" title="statement not covered" >      return this.existing;</span>
    }
&nbsp;
    // in case client version does not support hooks
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.client.hooks || typeof this.client.hooks.getAll !== 'function') {
...
&nbsp;
    // Do nothing if not set
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!hooks) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
