...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/connections.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> connections.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import dotProp from 'dot-prop';
...
&nbsp;
  async getType(): Promise&lt;Asset[] | null&gt; {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.existing === null) <span class="cstat-no" title="statement not covered" >return [];</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!connections)
...
&nbsp;
    // Do nothing if not set
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!connections) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
