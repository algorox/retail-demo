...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/migrations.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> migrations.ts</h1>
        <div class='clearfix'>
...
&nbsp;
  ...
  async getType(): Promise&lt;Asset[] | {}&gt; {
    try {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (err.statusCode === 404) return {};
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (migrations &amp;&amp; Object.keys(migrations).length &gt; 0) {
