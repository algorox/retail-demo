...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/clients.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> clients.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!clients) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
