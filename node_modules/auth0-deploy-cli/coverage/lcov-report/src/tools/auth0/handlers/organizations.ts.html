...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/organizations.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> organizations.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">92.15% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>94/102</span>
            </div>
...
<span class="cstat-no" title="statement not covered" >      log.warn(`Detected the following organizations should be deleted. Doing so may be destructive.\nYou can enable deletes by setting 'AUTH0_ALLOW_DELETE' to true in the config</span>
      \n${data.map(<span class="fstat-no" title="function not covered" >(i</span>) =&gt; <span class="cstat-no" title="statement not covered" >this.objString(i))</span>.join('\n')}`);
    }
  }
&nbsp;
      ...
      myChanges.map(async (change) =&gt; {
        switch (true) {
          ...
          case change.update &amp;&amp; change.update.length &gt; 0:
            <span class="missing-if-branch" title="else path not taken" >E</span>if (change.update) await this.updateOrganizations(change.update, existing);
            break;
          default:
            break;
        }
