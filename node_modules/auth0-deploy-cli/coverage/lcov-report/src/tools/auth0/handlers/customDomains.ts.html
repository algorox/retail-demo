...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/customDomains.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> customDomains.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!customDomains) <span class="cstat-no" title="statement not covered" >return;</span>
    const changes = await this.calcChanges(assets).then((changes) =&gt; {
      const changesWithoutUpdates = {
        ...
        create: changes.create.map((customDomainToCreate) =&gt; {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (customDomainToCreate.custom_client_ip_header === null) {
<span class="cstat-no" title="statement not covered" >            delete newCustomDomain.custom_client_ip_header;</span>
          }
&nbsp;
