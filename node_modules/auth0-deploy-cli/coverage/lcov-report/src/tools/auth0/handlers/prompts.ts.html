...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/prompts.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> prompts.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">60200x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
    ...
    const data = await Promise.all(
      ...
      return customTextData
        ...
        .reduce((acc: AllPromptsByLanguage, customTextItem) =&gt; {
          <span class="missing-if-branch" title="if path not taken" >I</span>if (customTextItem<span class="branch-0 cbranch-no" title="branch not covered" >?.l</span>anguage === undefined) <span class="cstat-no" title="statement not covered" >return acc;</span>
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!prompts) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
    const { customText, ...promptSettings } = prompts;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!isEmpty(promptSettings)) {
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!languageScreenTypes) <span class="cstat-no" title="statement not covered" >return [];</span>
&nbsp;
        return Object.keys(languageScreenTypes).map((prompt: PromptTypes) =&gt; {
          const body = languageScreenTypes[prompt] || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
