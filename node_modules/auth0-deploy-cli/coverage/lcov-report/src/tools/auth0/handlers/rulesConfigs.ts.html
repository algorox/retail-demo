...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/rulesConfigs.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> rulesConfigs.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Assets, Asset, CalculatedChanges } from '../../../types';
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!rulesConfigs || !rulesConfigs.length)
