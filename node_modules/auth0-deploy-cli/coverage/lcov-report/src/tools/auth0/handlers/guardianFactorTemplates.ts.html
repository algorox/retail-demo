...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/guardianFactorTemplates.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> guardianFactorTemplates.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!guardianFactorTemplates || !guardianFactorTemplates.length) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
