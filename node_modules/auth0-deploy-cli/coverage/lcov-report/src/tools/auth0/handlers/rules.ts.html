...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/rules.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> rules.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">92.53% </span>
...
&nbsp;
    ...
    const futureRules = [
      ...create,
      ...update,
      ...del.filter(<span class="fstat-no" title="function not covered" >(r</span>) =&gt; <span class="cstat-no" title="statement not covered" >excludedRules.includes(r.name))</span>,
    ];
&nbsp;
...
&nbsp;
    // Do nothing if not set
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!rules) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
    // Figure out what needs to be updated vs created
...
&nbsp;
    ...
    await this.client.pool
      .addEachTask({
        ...
        generator: <span class="fstat-no" title="function not covered" >(r</span>ule) =&gt;
<span class="cstat-no" title="statement not covered" >          this.client.rules</span>
            .update({ id: rule.id }, stripFields(rule, this.stripUpdateFields))
            .then(<span class="fstat-no" title="function not covered" >() =</span>&gt; {
              const updated = <span class="cstat-no" title="statement not covered" >{</span>
                name: rule.name,
                stage: rule.stage,
                order: rule.order,
                id: rule.id,
              };
<span class="cstat-no" title="statement not covered" >              log.info(`Temporally re-order Rule ${convertJsonToString(updated)}`);</span>
            }),
      })
      .promise();
&nbsp;
