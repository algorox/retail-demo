...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/branding.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> branding.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import DefaultHandler from './default';
...
&nbsp;
    try {
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.client.branding &amp;&amp; typeof this.client.branding.getSettings === 'function') {
        branding = await this.client.branding.getSettings();
      }
&nbsp;
      // in case client version does not custom domains
      <span class="missing-if-branch" title="else path not taken" >E</span>if (this.client.customDomains &amp;&amp; typeof this.client.customDomains.getAll === 'function') {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (err.statusCode === 403) return branding;
<span class="cstat-no" title="statement not covered" >      if (err.statusCode === 404) <span class="cstat-no" title="statement not covered" >return branding;</span></span>
<span class="cstat-no" title="statement not covered" >      if (err.statusCode === 501) <span class="cstat-no" title="statement not covered" >return branding;</span></span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (brandingSettings &amp;&amp; Object.keys(brandingSettings).length) {
...
&nbsp;
    ...
    if (branding.templates &amp;&amp; branding.templates.length) {
      const unknownTemplates = branding.templates
        ...
        .map(<span class="fstat-no" title="function not covered" >(t</span>) =&gt; <span class="cstat-no" title="statement not covered" >t.template)</span>;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (unknownTemplates.length) {
...
&nbsp;
      ...
      <span class="missing-if-branch" title="else path not taken" >E</span>if (templateDefinition &amp;&amp; templateDefinition.body) {
