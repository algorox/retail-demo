...
<head>
    <title>Code coverage report for src/tools/auth0/handlers/tenant.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../../../index.html">All files</a> / <a href="index.html">src/tools/auth0/handlers</a> tenant.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    blockPageKeys.forEach((key) =&gt; {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (tenant[key]) <span class="cstat-no" title="statement not covered" >delete tenant[key];</span>
    });
&nbsp;
    return tenant;
  }
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!tenant) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (updatedTenant &amp;&amp; Object.keys(updatedTenant).length &gt; 0) {
