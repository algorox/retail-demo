...
<head>
    <title>Code coverage report for src/tools/calculateChanges.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">src/tools</a> calculateChanges.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import log from '../logger';
...
&nbsp;
    ...
    if (desiredAssetState[fieldName] &amp;&amp; Object.keys(desiredAssetState[fieldName]).length) {
      ...
      // APIv2.
      <span class="missing-if-branch" title="else path not taken" >E</span>if (currentAssetState[fieldName]) {
        // eslint-disable-next-line no-restricted-syntax
            ...
            if (allowDelete) {
              ...
              log.warn(
                `Detected that the ${fieldName} of the following ${
                  handler.name || handler.id || <span class="branch-2 cbranch-no" title="branch not covered" >''</span>
...
export function calculateChanges({
  ...
  assets,
  existing,
  identifiers = <span class="branch-0 cbranch-no" title="branch not covered" >['id', 'name'],</span>
  allowDelete,
}: {
  handler: APIHandler;
  assets: Asset[];
  ...
  const findByKeyValue = (key: string, value: string, arr: Asset[]): Asset | undefined =&gt;
    arr.find((e) =&gt; {
      if (Array.isArray(key)) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (values.every((v) =&gt; v)) {
...
&nbsp;
  ...
  if (identifiers.includes('name')) {
    ...
    futureAssets.forEach((a) =&gt; {
      ...
      const inDeleted = del.filter((e) =&gt; e.name === a.name &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >e[uniqueID] !== a[uniqueID])</span>[0];
      <span class="missing-if-branch" title="else path not taken" >E</span>if (!inDeleted) {
