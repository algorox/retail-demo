...
<head>
    <title>Code coverage report for src/args.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> args.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import yargs from 'yargs';
...
&nbsp;
function <span class="fstat-no" title="function not covered" >getParams(</span>): CliParams {
  const args = <span class="cstat-no" title="statement not covered" >yargs</span>
...
<span class="cstat-no" title="statement not covered" >  return args.argv;</span>
}
&nbsp;
export default {
  getParams,
